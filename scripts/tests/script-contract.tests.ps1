...
'@
    ...
    Assert-Match 'Summary: 0 error\(s\), 9 info signal\(s\)' $r.Out 'skip-reachability: only the deliberately-undefined seams remain (six original, plus the two of the four issue #885 added that this repo still leaves undefined, plus Get-ReachLabel since #1870) -- the switch drops the reachability half and nothing else'
