...
# 04-13 · repo-lens (VUL-IN)

> Repo-lens for the portable manual of specialist 04-13 in the `dkj-subagents-alpha` plugin. This file was put
> in place by `sync-roster` as an empty template; the agent-def reads it along automatically.
> Fill in below the repo-specific tasks and context specialist 04-13 needs in this repo.
