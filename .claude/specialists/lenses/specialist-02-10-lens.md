...
# 02-10 · repo-lens (VUL-IN)

> Repo-lens for the portable manual of specialist 02-10 in the `dkj-subagents-lifehub` plugin. This file was put
> in place by `sync-roster` as an empty template; the agent-def reads it along automatically.
> Fill in below the repo-specific tasks and context specialist 02-10 needs in this repo.
