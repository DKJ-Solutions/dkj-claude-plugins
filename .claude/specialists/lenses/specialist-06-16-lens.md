...
- **`plugins/ADOPTION.md`** + **`plugins/dkj-subagents/README.md`** (which absorbed the root `README.md` retired on September 24, 2026) + **`.claude/specialists/README.md`** (the Specialists handbook): how the marketplace and
