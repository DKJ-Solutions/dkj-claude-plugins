...
> Part of the Claude Specialists — the portable playbook (plugin `dkj-subagents-alpha`). The specialist reads the repo-specific lens from `.claude/specialists/lenses/specialist-05-15-lens.md` (or the legacy path `.claude/extensions/05-15-extension.md`) of the consuming repo. Assigned by Chris, the Chief of Staff.
...
> `.claude/specialists/lenses/specialist-05-15-lens.md` (or the legacy path `.claude/extensions/05-15-extension.md`) of the consuming repo.*
