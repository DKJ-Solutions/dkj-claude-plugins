...
| issue **reopened** | a comment pointing to the issue for why -- it may be back with the requester, or it may be being worked on again -- and saying this is not a request to test |
...
**The reopened comment asserts nothing about which case it is, because the event cannot tell them
apart.** A reopen carries at least two opposite meanings -- the work is being picked up again, or the
issue is going back to the requester because what was built was reverted or was never this workflow's
to begin with -- and in the second case a comment that guesses "being worked on again, hold off on
testing" tells the person who has to act to sit still. So the comment names the two possibilities and
points to the issue for which one applies, instead of guessing. That is the failure inbound #2117
measured, 2026-09-18: on three real Asana cards the guessed line contradicted the true state and
outranked a colleague's own correction posted underneath it, because it carried the system's
authority.
