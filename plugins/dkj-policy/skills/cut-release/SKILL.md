...
the [performance engineer's own rule](https://github.com/DaveKJohn/claude-code-specialists/blob/main/plugins/dkj-subagents/dkj-subagents-alpha/manuals/06-25-manual.md) broken by the
