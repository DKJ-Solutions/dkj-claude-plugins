...
14. **A TEST SUITE's own scan output -- the first entry on this list that is not a script**
    ...
    **No live exploit today, and that is why it was filed rather than fixed in flight**: the tree holds
    ...
    incident.
15. **`$_.Exception.Message`, at every console site that prints one -- a value class that READS as ours
...
in one pass rather than one at a time -- then **fourteen** and **fifteen** on September 22, one off an
incidental find (#2280) and one off a second deliberate sweep (#2271). Each of the first six arrived
...
the moment somebody looked on purpose (#2247), then to fourteen the next day off another incidental
find (#2280) and to fifteen the same day off a second deliberate sweep (#2271) -- which argues that
