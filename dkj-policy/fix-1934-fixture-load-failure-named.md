...
The suites already capture the load failure and discard it. Judge the child's exit code at the invocation and print what was captured, naming the absent lib.
