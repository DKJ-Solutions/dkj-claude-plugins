...
**plugin-pad** (`.claude/specialists/lenses/`) — de nieuwe standaard-locatie
...
- **`specialists/manuals/specialist-06-24-manual.md`** — het draagbare vakboek, met "globaal = beschikbaar voor
...
lenzen die het indexeert naar `.claude/specialists/lenses/` waren verhuisd. Het
handboek is nu verplaatst naar het familie-niveau, pal boven de lenzen:
**`.claude/specialists/README.md`**.
...
- **`CLAUDE.md`** laadt Chris nu via **twee `@`-imports**: de draagbare body rechtstreeks uit de
  ...
  én de repo-lens (`@.claude/specialists/lenses/01-01-extension.md`).
