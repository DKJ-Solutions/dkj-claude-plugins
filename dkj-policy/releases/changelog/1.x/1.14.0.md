...
manuals (`specialist-04-12-manual.md`, `specialists-shopify/manuals/specialist-04-20-manual.md`, `specialist-04-13-manual.md`,
`specialist-04-11-manual.md`) describing the cross-browser check in that specialist's own context.
