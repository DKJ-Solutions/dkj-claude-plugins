...
([README.md](https://github.com/DKJ-Solutions/dkj-claude-plugins/blob/123878dd51f7e06861777805402ce46a55375e41/README.md#removal-the-teardown-gap)).
...
are described in [`CONTRIBUTING.md`](../../../../plugins/dkj-policy/CONTRIBUTING-portable.md).** Since August 14, 2026 that page is
deliberately the *standard workflow* — three rules, no entry, no fold, no cut — and it points at
[`workflow-davekjohn/CONTRIBUTING.md`](../../../../plugins/dkj-policy/CONTRIBUTING-portable.md) for exactly the mechanics
...
[`workflow-davekjohn/CLAUDE.md`](../../../../plugins/dkj-policy/CONTRIBUTING-portable.md) — the layer that applies on top and wins on conflict.
It is the same split [`CONTRIBUTING.md`](../../../../plugins/dkj-policy/CONTRIBUTING-portable.md) has made since August 14, 2026, extended
...
[Rendall #06](../../../../.claude/specialists/lenses/specialist-05-06-lens.md) lists five things the root states
