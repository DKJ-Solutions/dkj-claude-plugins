...
Both predicates open with a null guard a Mandatory parameter can never reach. Add [AllowNull()] to match the sibling Get-PluginUpdateScope, and assert the behaviour.
