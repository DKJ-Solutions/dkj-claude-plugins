...
Two repairs: (1) step 0a's trunk-occupancy refusal, whose ground expired when fold-on-merge.yml became merger-independent; (2) an auto-forward loop so a stale certificate is repaired by the script rather than by hand.
